...
namespace practical_Work_2 //Задания 1 и 2
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine("Нажмите любую кнопку для получения информации"); // Вывод текста в консоль 
                Console.WriteLine("Нажмите Esc чтобы выйти"); /// Вывод текста в консоль
